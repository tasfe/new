define(function (require, exports, module) {
  ...
  var ProfitAndLossReportView = Base.Prefab.SearchGrid.extend({

    template: require('text!dataCenter/templates/profitAndLossReport.html'),
    ...
    initialize: function () {
      ...
      _(this.options).extend({
        ...
        ajaxOps: {
          url: '/intra/sysreport/profitstatreport.json'
        },
        subOps: {
          url: '/intra/sysreport/profitdetailstat.json',
          data: ['userId']
        }
      });
    },
    ...
    onRender: function () {
      ...
      new Global.Prefab.Timeset({
        ...
        startTime: 'startTime',
        endTime: 'endTime',
        strDefaultValue: _(moment()).toDate(),
        endDefaultValue: _(moment()).toDate(),
    ...
    formatRowData: function (rowInfo) {
      ...
      if (this.hasSub() && rowInfo.userName === this.getCurtSub().label) {
        ...
        row.push('<a class="js-pf-sub" data-label="' + rowInfo.userName +
          '" data-user-id="' + rowInfo.userId + '" data-="' + rowInfo.day + '" href="javascript:void(0)">' + rowInfo.userName +  '&nbsp;&nbsp;');
      }
  ...
  module.exports = ProfitAndLossReportView;
});
//56250