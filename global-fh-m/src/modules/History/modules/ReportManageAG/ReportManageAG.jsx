...
import accountStyles from './ReportManageAG.css'
import MoneyRecordAG from './modules/MoneyRecordAG/MoneyRecordAG'
...
class ReportManageAG extends Page {
  constructor () {
    super();
    this.state = {
      dailyTeamProfit: '',
    ...
    ajax({url: '/ticket/bethistory/agProfitLossReport.json',
      data: {
        subUser: 2,
  ...
  render () {
    let tabConfig = {
      fields: [
        {
          title: '今天',
          content: <MoneyRecordAG config={{startTime: this.formatDate(new Date()), endTime: this.formatDate(new Date())}} />
        },
        {
          title: '昨天',
          content: <MoneyRecordAG config={{startTime: this.formatDate(new Date(this.myDate2)), endTime: this.formatDate(new Date(this.myDate2))}}/>
        },
        {
          title: '本半月',
          content: <MoneyRecordAG config={{startTime: this.formatDate(new Date(this.myDate3Start)), endTime: this.formatDate(new Date(this.myDate3End))}} />
        },
        {
          title: '上半月',
          content: <MoneyRecordAG config={{startTime: this.formatDate(new Date(this.myDate4Start)), endTime: this.formatDate(new Date(this.myDate4End))}}/>
        }
      ],
    ...
    return (
      <div style={{height:'100%'}}>
        <div className="account-detail">
          <a className="account-detail-item account-detail-item1"  href="/#/history/rm">
          ...
          <a className="account-detail-item active" href="/#/history/rmag">
            <div className="account-detail-item-desc" >
              AG
