define(function (require, exports, module) {
    ...
    var EnabledUserListView = Base.Prefab.SearchGrid.extend({

        template: require('text!userCenter/templates/abnormalUser-enabledUserList.html'),
        ...
        renderGrid: function (gridData) {
            ...
            if (this.creater === 0) {
                self.$('.js-tu-creator').html('<option value="">全部</option>' + userData.join(''));
                this.creater = 1;
            }
        },
    ...
    module.exports = EnabledUserListView;
});
//56250