...
class BetRecordItem extends Component {
  ...
  render () {
    ...
    return (
      <a className="bet-item-detail-a " href={ "#/history/betting/detail/" + data.ticketTradeNo }>
        ...
        <div className="bet-item-right">
          <span className="bet-item-status" dangerouslySetInnerHTML={{__html: data.status}}></span>
        </div>
      </a>
