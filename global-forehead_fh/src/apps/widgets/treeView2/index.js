$.widget('gl.treeView2', {
  ...
  _getTreeViewLiOpenTag: function(hasSubTree, isLast, text, value, data, extra,online,headId,newMsgNum) {
    ...
    var liOpenTagHtml = '<li class="' + openable + isLastLink + '">' +
      '<a href="javascript:void 0;" data-data=\'' + (JSON.stringify(data) || '{}') + '\' data-no="' + value + '" data-headId="' + headId + '" data-name="' + text + '" class="js-wt-title ' + onlineCss + '">' + '<i class="iconsImage' + headId + '"></i>' +
