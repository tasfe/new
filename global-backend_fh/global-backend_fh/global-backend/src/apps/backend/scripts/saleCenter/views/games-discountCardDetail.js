define(function (require, exports, module) {
    ...
    var DiscountCardDetailView = Base.Prefab.SearchGrid.extend({

        template: require('text!saleCenter/templates/games-discountCardDetail.html'),
    ...
    module.exports = DiscountCardDetailView;
});