define(function (require, exports, module) {
  ...
  var bankManagementAddOrEditView = Base.ItemView.extend({
    ...
    template: require('text!./edit-Mobile.html'),
    ...
    onRender: function(){
      ...
      if(this.options.payType==1||this.options.payType==2||this.options.payType==3){
        this.$('.js-fc-tpm-AOE-pm-View').html('<div class="form-group form-inline">'+
            ...
            '</select></div></div>');
        this.$('.js-fc-tpm-AOE-merchantName-View').html();
        this.$('.js-fc-tpm-AOE-publicKey-View').html('<div class="form-group form-inline">'+
            '<label class="col-sm-3 control-label">公钥：</label>'+
            '<div class="col-sm-9">'+
            '<input type="text" class="js-fc-tpm-AOE-publicKey form-control" data-parsley-somespecialchar data-parsley-maxlength="5000" style="width: 400px;" required>'+
            '</div> </div>');
        this.$('.js-fc-tpm-AOE-pic-View').html('');
        this.$('.js-fc-tpm-AOE-tip-View').html('');
      }
      if(this.options.payType==4||this.options.payType==5){
        this.$('.js-fc-tpm-AOE-pm-View').html('<div class="form-group form-inline">'+
            ...
            '</select></div></div>');
        this.$('.js-fc-tpm-AOE-merchantName-View').html('<div class="form-group form-inline"><label class="col-sm-3 control-label">商户名：</label>'+
            '<div class="col-sm-9">'+
            '<input type="text" class="js-fc-tpm-AOE-merchantName form-control" data-parsley-somespecialchar data-parsley-maxlength="1000"  style="width: 200px;" required>'+
            '</div></div>');
        this.$('.js-fc-tpm-AOE-publicKey-View').html('<div class="form-group form-inline"><label class="col-sm-3 control-label">上传二维码：</label>'+
            '<div class="col-sm-9"><div class="js-fc-tpm-AOE-publicKey">'+
            '</div></div></div>');

        this.$('.js-fc-tpm-AOE-tip-View').html('<div class="form-group form-inline"><label class="col-sm-3 control-label text-danger">注：</label>'+
      ...
      if(this.options.type==='add'){
        this.$('.js-fc-tpm-AOE-payUrl').val(this.options.payUrl);
          if(this.options.payType==4||this.options.payType==5){
                this.$('.js-fc-tpm-AOE-publicKey').imgBar();
          }else{
      ...
      if(this.options.type==='edit'){
        ...
        this.$('.js-fc-tpm-AOE-merchantName').val(this.options.merchantName);
          if(this.options.payType==4||this.options.payType==5){
              this.$('.js-fc-tpm-AOE-publicKey').imgBar({imgList:(this.options.publicKey).split(',')});
          }else{
              this.$('.js-fc-tpm-AOE-publicKey').val(this.options.publicKey);
          }
