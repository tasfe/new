define(function (require, exports, module) {
    ...
    var QuotaManageLevelOneView = Base.ItemView.extend({
        ...
        template: require('text!userCenter/templates/quotaManage-levelThree.html'),
        ...
        renderBaseInfo: function (root) {
            if(root && root.level3 && _(root.level3).size()==2){
                var quotaNumArr = _(root.level3).sort(function(item){
                    return -item.rebate;
                });
