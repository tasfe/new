...
class Add extends Page {
  ...
  render () {
    return (
      <div>
        <div className="help-block">提示：安全问题用于找回登录密码和资金密码，请谨慎填写。</div>
        <div className="resetpwd-title-bar padding-h-sm">
          <div className="resetpwd-title reset-tt1 ">1.输入安全问题 </div>
          <div className="resetpwd-title reset-tt2 hidden">2.确认安全问题</div>
          <div className="resetpwd-title reset-tt3 hidden">3.设置成功</div>
        </div>
        {
          <form className="">
                ...
                <div className="step2 usepsdproqes ">
                  <div className="preoqescon">
                    <div className="row-outer">
                      <div className="row">
                        <div className="step2-q-num">选择问题1：</div>
                  ...
                  <div className="preoqescon">
                    <div className="row-outer">
                      <div className="row">
                        <div className="step2-q-num">选择问题2：</div>
                  ...
                  <div className="preoqescon">
                    <div className="row-outer">
                      <div className="row">
                        <div className="step2-q-num">选择问题3：</div>
