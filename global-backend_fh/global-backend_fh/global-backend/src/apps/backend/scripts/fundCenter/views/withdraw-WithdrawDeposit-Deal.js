define(function (require, exports, module) {
  ...
  var NormalWithdrawAuditView = Base.ItemView.extend({

    template: require('text!fundCenter/templates/withdraw-NormalWithdrawDeposit-deal.html'),
  ...
  module.exports = NormalWithdrawAuditView;
});