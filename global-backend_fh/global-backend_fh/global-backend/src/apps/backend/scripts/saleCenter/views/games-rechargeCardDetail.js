define(function (require, exports, module) {
    ...
    var RechargeCardDetailView = Base.Prefab.SearchGrid.extend({

        template: require('text!saleCenter/templates/games-rechargeCardDetail.html'),
    ...
    module.exports = RechargeCardDetailView;
});