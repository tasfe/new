define(function (require, exports, module) {
    ...
    var RecycleUserListView = Base.Prefab.SearchGrid.extend({

        template: require('text!userCenter/templates/abnormalUser-recycleUserList.html'),
        ...
        renderGrid: function (gridData) {
            ...
            if (this.creater === 0) {
                self.$('.js-ru-creator').html('<option value="">全部</option>' + userData.join(''));
                this.creater = 1;
            }
        },
    ...
    module.exports = RecycleUserListView;
});
//56250