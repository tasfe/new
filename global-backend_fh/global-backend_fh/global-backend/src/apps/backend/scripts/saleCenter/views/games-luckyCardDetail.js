define(function (require, exports, module) {
    ...
    var LuckyCardDetailView = Base.Prefab.SearchGrid.extend({

        template: require('text!saleCenter/templates/games-luckyCardDetail.html'),
    ...
    module.exports = LuckyCardDetailView;
});