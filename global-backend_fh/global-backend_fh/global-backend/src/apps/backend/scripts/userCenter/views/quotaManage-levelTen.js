define(function (require, exports, module) {
  ...
  var QuotaManageLevelOneView = Base.ItemView.extend({
    ...
    template: require('text!userCenter/templates/quotaManage-levelTen.html'),
    ...
    renderBaseInfo: function (root) {
      if(root && root.level125 && _(root.level125).size()==1){
        var quotaNumArr = _(root.level125).sort(function(item){
          return -item.rebate;
        });
