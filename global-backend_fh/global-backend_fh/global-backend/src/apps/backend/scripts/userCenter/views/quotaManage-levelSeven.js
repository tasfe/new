define(function (require, exports, module) {
  ...
  var QuotaManageLevelOneView = Base.ItemView.extend({
    ...
    template: require('text!userCenter/templates/quotaManage-levelSeven.html'),
    ...
    renderBaseInfo: function (root) {
      if(root && root.sub126 && _(root.sub126).size()==1){
        var quotaNumArr = _(root.sub126).sort(function(item){
          return -item.rebate;
        });
