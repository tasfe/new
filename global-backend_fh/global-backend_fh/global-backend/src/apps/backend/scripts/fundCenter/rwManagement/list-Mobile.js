define(function (require, exports, module) {
    ...
    var BankManagementAddOrEditView = require('./edit-Mobile');

    var ListMobileView = Base.ItemView.extend({

        template: require('text!./list-Mobile.html'),
